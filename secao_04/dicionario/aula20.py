...
dic_01['lista'][3] = 999 # Alterando um valor dentro da lista (mutável) que é um valor do dicionário
...
print('Dic_04', dic_04) # dic_04 é uma cópia profunda, então não reflete as mudanças feitas em dic_01
...
print(id(dic_04)) # ID de dic_04 (diferente de todos os outros)
